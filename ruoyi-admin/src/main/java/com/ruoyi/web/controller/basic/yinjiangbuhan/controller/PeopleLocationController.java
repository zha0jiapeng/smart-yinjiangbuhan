...
//    @Scheduled(fixedRate = 2000)
    ...
    private void pushSwzkIn() {
        ...
        HttpResponse execute = HttpRequest.post("http://192.168.1.200:9501/push/list")
                ...
                .execute();
        String body = execute.body();
        System.out.println("人员定位接口信息：" + body);
...
//        }
        ...
        for (Map<String, Object> itemMap : datee) {
            // 一行完成所有检查
            Object idcard = itemMap.get("user_info") instanceof Map ?
                    ((Map<String, Object>) itemMap.get("user_info")).get("number") : null;
