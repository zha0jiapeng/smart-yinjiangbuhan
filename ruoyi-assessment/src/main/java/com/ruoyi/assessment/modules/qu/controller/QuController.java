package com.ruoyi.assessment.modules.qu.controller;
...
import com.ruoyi.assessment.core.utils.excel.ExportExcel;
import com.ruoyi.assessment.core.utils.excel.ImportExcel;
...
public class QuController extends BaseController {
    ...
    public ApiRest importFileTemplate(HttpServletResponse response) {
        try {
            ...
            List<QuExportDTO> list = new ArrayList<>();
