...
import com.ruoyi.assessment.modules.exam.dto.ExamRepoDTO;
import com.ruoyi.assessment.modules.exam.dto.ext.ExamRepoExtDTO;
import com.ruoyi.assessment.modules.exam.service.ExamRepoService;
...
import com.ruoyi.assessment.modules.paper.dto.ext.PaperQuAnswerExtDTO;
...
import com.ruoyi.assessment.modules.paper.entity.PaperQuAnswer;
import com.ruoyi.assessment.modules.paper.enums.ExamState;
import com.ruoyi.assessment.modules.paper.enums.PaperState;
import com.ruoyi.assessment.modules.paper.mapper.PaperMapper;
import com.ruoyi.assessment.modules.paper.service.PaperQuAnswerService;
...
import com.ruoyi.assessment.modules.qu.entity.Qu;
import com.ruoyi.assessment.modules.qu.entity.QuAnswer;
import com.ruoyi.assessment.modules.qu.enums.QuType;
import com.ruoyi.assessment.modules.qu.service.QuAnswerService;
import com.ruoyi.assessment.modules.qu.service.QuService;
import com.ruoyi.assessment.modules.sys.user.entity.SysUser;
import com.ruoyi.assessment.modules.user.book.service.UserBookService;
import com.ruoyi.assessment.modules.user.exam.service.UserExamService;
...
public class PaperServiceImpl extends ServiceImpl<PaperMapper, Paper> implements PaperService {
    ...
    @Override
    public String createPaper(String userId, String examId, Integer type) {
        //校验是否有正在考试的试卷
        QueryWrapper<Paper> wrapper = new QueryWrapper<>();
        wrapper.lambda().eq(Paper::getUserId, userId).eq(Paper::getState, PaperState.ING);
        Paper pp = this.getOne(wrapper, false);
        if (pp != null) {
            throw new com.ruoyi.common.exception.ServiceException("当前用户存在正在进行中的考试。", 10001);
        }
        ...
        //保存试卷内容
        return this.savePaper(userId, exam, quList, type);
    }
     ...
     * @return
     */
    private String savePaper(String userId, ExamDTO exam, List<PaperQu> quList, Integer type) {
    ...
    public void handExam(String paperId) {
        ...
        for (PaperQuDTO qu : list) {
            ...
            //加入错题本
            userBookService.addBook(paper.getExamId(), qu.getQuId(), userId);
        }
    }
