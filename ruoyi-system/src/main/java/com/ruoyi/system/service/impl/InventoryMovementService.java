...
import com.ruoyi.system.constant.InventoryMovementConstant;
...
import com.ruoyi.system.mapper.InventoryMovementDetailMapper;
import com.ruoyi.system.mapper.InventoryMovementMapper;
...
public class InventoryMovementService {
  ...
  public InventoryMovementFrom selectById(Long id) {
    ...
    InventoryMovementFrom form = this.do2form(order);
  ...
  public Page<InventoryMovementVO> selectList(InventoryMovementQuery query, Pageable page) {
    ...
    List<InventoryMovementVO> res = this.dos2vos(list);
  ...
  private void saveDetails(Long orderId, List<InventoryMovementDetailVO> details) {
    if (!CollUtil.isEmpty(details)) {
      ...
      List<InventoryMovementDetail> inventoryMovementDetails = this.vos2dos(details);
