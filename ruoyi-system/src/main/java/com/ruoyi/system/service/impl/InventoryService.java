...
import com.ruoyi.system.pojo.vo.AreaAndItemInfo;
import com.ruoyi.system.pojo.vo.InventoryVO;
import com.ruoyi.system.pojo.vo.PlaceAndItem;
...
public class InventoryService {
    ...
    private int saveData(List<InventoryHistory> list, LocalDateTime now, Long userId,
        ...
        list.forEach(it -> {
            ...
            v = this.inventoryHistory2invertory(it);
            v.setCreateTime(now);
    ...
    public Page<InventoryVO> queryPage(InventoryQuery query, Pageable page) {
        ...
        List<InventoryVO> res = this.dos2vos(list);
