...
public class OssClientConfig implements Serializable {
    ...
    @Bean(value = "ossClient", destroyMethod = "shutdown")
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(endpoint, that.endpoint) &&
                ...
                Objects.equals(autoCreateBucket, that.autoCreateBucket);
    }

    @Override
    public int hashCode() {
        return Objects.hash(endpoint, accessKeyId, accessKeySecret, bucketName, autoCreateBucket);
    }
